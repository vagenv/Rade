 ...
 */
UENUM(BlueprintType)
enum class ERLoadingScreenLayout : uint8
{
	/**
...
struct RLOADINGSCREENLIB_API FALoadingScreenSettings
{
	...
	/**
	 * Select loading screen Layout. Ignore this if you choose "Show Widget Overlay = false"
	 */
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Loading Screen Settings")
	ERLoadingScreenLayout Layout = ERLoadingScreenLayout::ALSL_Classic;
};
